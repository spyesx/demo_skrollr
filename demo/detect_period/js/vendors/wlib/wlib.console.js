...
(function()
{
    function Console()
    {
        ...
        this.group       = function(name){  if(_isOn){ console.group(name);}};
        this.groupEnd    = function(name){  if(_isOn){ console.groupEnd(name);}};
        this.dir         = function(){      if(_isOn){ console.dir(arguments);}};
        this.dirxml      = function(){      if(_isOn){ console.dirxml(arguments);}};
        this.time        = function(name){  if(_isOn){ console.time(name);}};
        this.timeEnd     = function(name){  if(_isOn){ console.timeEnd(name);}};
    }
